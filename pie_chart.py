...
def advanced_filter_data_by_search_query(df, query):
    ...
    return df[df['Description'].str.contains(pattern) | df['No.'].astype(str).str.contains(pattern) | df['graphics 01'].str.contains(pattern) | df['graphics 02'].str.contains(pattern)]
...
def display_data_page():
    ...
    with col2:
        st.title("Remanufactured stocklist Lenovo Original Warranty")

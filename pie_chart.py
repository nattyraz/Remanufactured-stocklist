...
def advanced_filter_data_by_search_query(df, query):
    ...
    return df[df['Description'].str.contains(pattern) | df['No.'].astype(str).str.contains(pattern) | df['Graphics01'].astype(str).str.contains(pattern) | df['Graphics02'].astype(str).str.contains(pattern)]

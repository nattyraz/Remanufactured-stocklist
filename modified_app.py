...
if st.sidebar.checkbox("Filter by References"):
    st.subheader("Filter by References")
    ref_options = ['01 New', '02 Bulk', 'GOLD', 'SILVER', 'BRONZE', 'Demo', '08 Ref.', '04 Demo']
...
# New Page for Grades
if st.sidebar.checkbox("Filter by Grades"):
    st.subheader("Filter by Grades")
    grade_options = ['Grade A', 'Grade B', 'Grade C', 'Defekt']
...
# New Page for Premium
if st.sidebar.checkbox("Filter by Premium"):
    st.subheader("Filter by Premium")

...
def display_data_page():
    ...
    selected_rows = st.multiselect("Sélectionnez les références:", filtered_data.index, default=[])
    st.table(filtered_data.loc[selected_rows])

    # Download selected data
    if st.button("Télécharger la sélection"):
        selected_data = filtered_data.loc[selected_rows]

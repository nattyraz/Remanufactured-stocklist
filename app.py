...
def display_data_page():
    ...
    filters = {
        "Item Category Code": st.multiselect("Item Category Code", list(combined_data["Item Category Code"].unique())),
        "Product Group Code": st.multiselect("Product Group Code", list(combined_data["Product Group Code"].unique())),
        "Keyboard Language": st.multiselect("Keyboard Language", list(combined_data["Keyboard Language"].unique())),
        "Condition": st.multiselect("Condition", list(combined_data["Condition"].unique()))
    }
